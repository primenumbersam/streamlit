...
# --- 설정 ---
CAFE24_PUBLIC_URL = "https://ecimg.cafe24img.com/pg1892b93862555010/laroe/web/assets"
ASSETS_DIR = Path("assets")
SOURCE_HTML_DIR = Path("product-detail")
EXPORT_DIR = Path("product-detail-export")

def process_html_files() -> None:
    """HTML 파일의 이미지 경로를 Cafe24 URL로 변경하고 내보냅니다."""
    print("--- HTML 파일 에셋 경로 변환 시작 (Cafe24) ---")
    ...
    new_path_pattern = f"{CAFE24_PUBLIC_URL}/"
